            ...
            <View style={styles.container}>
                ...
                <View style={styles.chart}>
                    ...
                    >
                        ...
                        >
                            <VictoryBar data={manPopulation} />
                            <VictoryBar data={womanPopulation} />
                        </VictoryGroup>
                    </VictoryChart>
                </View>
            </View>
